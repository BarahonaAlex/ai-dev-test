...
const getUsers = () => {
    ...
    const request = http.get('https://jsonplaceholder.typicode.com/users', (response) => {
...
const getAlbums = () => {
    ...
    const request = http.get('https://jsonplaceholder.typicode.com/albums', (response) => {
        // Set the encoding, so we don't get log to the console a bunch of gibberish binary data
        response.setEncoding('utf8');
...
const getPhotos = () => {
    ...
    const request = http.get('https://jsonplaceholder.typicode.com/photos', (response) => {
        // Set the encoding, so we don't get log to the console a bunch of gibberish binary data
        response.setEncoding('utf8');
